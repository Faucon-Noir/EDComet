  ...
  return (
    <>
      ...
      <Box sx={{ width: '50%', justifySelf: 'center', marginTop: '20px' }}>
        {progress}%
        <LinearProgressWithLabel color='info' variant='determinate' value={progress} />
      </Box>
      <Box>
        Estimated payment:  {estimatedPayment} |
        Resources required: {totalUnitsRequired} |
        Travels required with your current ship cargo capacity: {travels}
      </Box>
      <Box>
        <List>
          {(
            [...(data.ResourcesRequired ?? [])]
              ...
              .map((ressource: ColonisationConstructionDepotResource) => {
                ...
                const isChecked = diff === 0 || checked.indexOf(ressource.Name) !== -1;
                return (
                  <ListItem
                    key={ressource.Name}
                    dense
                  ...
                  >
                    ...
                    >
                      ...
                      <ListItemText
                        ...
                        sx={isChecked ? { textDecoration: 'line-through', color: 'grey.500' } : {}}
                      />
                    </ListItemButton>
                  </ListItem>
                );
